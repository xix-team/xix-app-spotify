(function() {
	...
	if(!namespace.Drawing) {
		...
		Drawing.drawLinesEllipse = function(ctx, x, y, w, h, complete, fill, stroke, strokeWidth, strokeColor)
		{
			...
			if(strokeWidth != null || strokeWidth != undefined) ctx.lineWidth = strokeWidth;
			if(strokeColor != null || strokeColor != undefined) ctx.strokeStyle = strokeColor;
		...
		{
			var p, yRatio = h/w;
			var points = SimpleTrig.getPointsOnACircle(w/2, {x:x, y:y}, numDots);
